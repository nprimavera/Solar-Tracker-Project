...
#include <Math.h>                                             // Include the math library (fractions ect.)
...
for (int i = 0; i <= 90; i = i + 10){                         // Initialization; condition; increment
  ...
  delay(200);                                                // Stop the program for 200 milliseconds ~ 0.2 seconds  
...
for (int j = 0; j <= 90; j = j + 10){
    ...
    delay(2000);                                              // Delay for 2 seconds before the loop runs again 
